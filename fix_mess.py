...
# Let's take the original layout.txt and do the replacement correctly this time.
# The actual layout return in layout.txt is:
#   return (
#     <div className="h-screen w-full bg-[#F0F2F5] text-[#050505] flex font-sans overflow-hidden">

layout_return_str = '  return (\n    <div className="h-screen w-full bg-[#F0F2F5] text-[#050505] flex font-sans overflow-hidden">'
start_idx = orig_text.find(layout_return_str)
