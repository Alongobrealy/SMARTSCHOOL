...
end_str = "{/* TAB 2: CONFIGURATION ÉTABLISSEMENT, CYCLES, CLASSES & PERMISSIONS */}"
              ...
              <div className="flex flex-col gap-6 w-full animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <button className="px-4 py-2 bg-white border border-slate-300 text-slate-700 font-medium rounded-lg shadow-sm hover:bg-slate-50 transition-colors text-sm cursor-pointer">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {/* Card 1 */}
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 flex flex-col gap-2 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-2">
                  ...
                  <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <select className="text-xs font-medium bg-slate-50 border border-slate-200 text-slate-600 rounded-lg px-3 py-1.5 outline-none cursor-pointer hover:bg-slate-100 transition-colors">
