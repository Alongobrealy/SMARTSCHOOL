...
# Find the start (the main component return)
start_idx = text.find('  return (\n    <div className="h-screen w-full bg-[#F0F2F5] text-[#050505] flex font-sans overflow-hidden">')
if start_idx == -1:
    # Just try to find line 342's return manually
    lines = text.split('\n')
...
if start_idx != -1 and content_start_idx != -1:
    ...
    print("Could not find boundaries", start_idx, content_start_idx)
