...
export const FeeRevenueChart: React.FC<FeeRevenueChartProps> = ({ payments }) => {
  ...
  return (
    <div className="bg-white  border border-slate-200  p-5 rounded-lg shadow-sm transition-colors duration-200 flex flex-col w-full h-[400px]">
      <div className="mb-4">
        <h3 className="text-lg font-black text-slate-800 ">Évolution des Encaissements</h3>
        <p className="text-xs text-slate-500 ">Paiements validés par mois (Année Académique)</p>
      </div>
