          ...
          <div className="p-6 sm:p-7 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
                    {plans.map((p) => {
                      ...
                      return (
                        ...
                        >
                          {p.isPopular && (
                            <div className="absolute -top-2.5 right-3 bg-amber-500 text-slate-950 font-black text-[9px] px-2 py-0.5 rounded-lg shadow-xs uppercase tracking-wider flex items-center gap-1">
            ...
            {activeTab === 'code' && (
              <form onSubmit={handleActivateWithCode} className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="bg-amber-50  border border-amber-300  rounded-lg p-4 text-xs text-amber-950  space-y-2">
                  ...
                  <div className="bg-amber-100/70  p-2.5 rounded-xl text-[11px] font-mono text-amber-900 ">
                  ...
                  {hasVerifiedCode && codeVerificationResult && (
                    <div className="animate-in fade-in duration-200">
                      {codeVerificationResult.isValid ? (
                        ...
                        <div className="p-4 rounded-lg bg-rose-50  border border-rose-300  text-rose-900  text-xs flex items-start gap-3">
                          <AlertTriangle className="w-5 h-5 text-rose-600 shrink-0 mt-0.5" />
                          <div>
                            <strong className="block font-bold">Code non reconnu ou non autorisé :</strong>
                            <p className="mt-0.5 text-rose-800 ">{codeVerificationResult.errorMessage}</p>
                          </div>
                        </div>
                      )}
                    </div>
